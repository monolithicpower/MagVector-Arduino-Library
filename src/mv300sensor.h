...
public:
  ...
  void readMagneticComponents(uint16_t *magFieldBx, uint16_t *magFieldBy, uint16_t *magFieldBz, uint16_t *temperature, uint8_t *frameCounter, uint8_t triggerMode=1);
  ...
  void readMagneticComponentsWithCrcCheck(uint16_t *magFieldBx, uint16_t *magFieldBy, uint16_t *magFieldBz, uint16_t *temperature, uint8_t *frameCounter, bool *crcErrorDetected, uint8_t triggerMode=1);
